...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "A selection of wet lab and dry lab projects from my work.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6B%77%61%6C%74%65%72@%6D%61%69%6C%62%6F%78.%6F%72%67", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/katrin-walter", "_blank");
        },
      },{
      id: 'light-theme',
